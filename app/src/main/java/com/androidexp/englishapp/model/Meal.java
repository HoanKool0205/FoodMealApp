...
import androidx.annotation.NonNull; // Nhập khẩu chú thích @NonNull
...
/**
 * Meal class represents a meal object with various attributes related to meal information.
 */
@Entity(tableName = "mealInformation")
public class Meal {

    @PrimaryKey
    @NonNull // Đánh dấu idMeal là không nullable
